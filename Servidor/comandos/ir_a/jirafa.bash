...
path=$HOME/repositorio2/Robot/src/proy_nexa/pro_nexa_nav2_system/config/my_map.yaml
...
ros2 launch proy_nexa_action proy_nexa_action_client_girafa.launch.py 
