...
#ifndef PROY_NEXA_INTERFACE__SRV__DETAIL__MY_MOVE_MSG__FUNCTIONS_H_
#define PROY_NEXA_INTERFACE__SRV__DETAIL__MY_MOVE_MSG__FUNCTIONS_H_
 ...
 * calls
 * proy_nexa_interface__srv__MyMoveMsg_Request__init().
...
/**
 * It calls
 * proy_nexa_interface__srv__MyMoveMsg_Request__fini()
...
/// Check for srv/MyMoveMsg message equality.
/**
 ...
 * proy_nexa_interface__srv__MyMoveMsg_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * proy_nexa_interface__srv__MyMoveMsg_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/MyMoveMsg message array equality.
/**
...
/// Copy an array of srv/MyMoveMsg messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * proy_nexa_interface__srv__MyMoveMsg_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_proy_nexa_interface
...
/**
 * It calls
 * proy_nexa_interface__srv__MyMoveMsg_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_proy_nexa_interface
...
/**
 * It allocates the memory for the array and calls
 * proy_nexa_interface__srv__MyMoveMsg_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_proy_nexa_interface
...
/**
 * It calls
 * proy_nexa_interface__srv__MyMoveMsg_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // PROY_NEXA_INTERFACE__SRV__DETAIL__MY_MOVE_MSG__FUNCTIONS_H_
