...
#include <stddef.h>
#include "proy_nexa_interface/srv/detail/my_move_msg__rosidl_typesupport_introspection_c.h"
...
#include "proy_nexa_interface/srv/detail/my_move_msg__struct.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  proy_nexa_interface__srv__MyMoveMsg_Request__init(message_memory);
}

void MyMoveMsg_Request__rosidl_typesupport_introspection_c__MyMoveMsg_Request_fini_function(void * message_memory)
{
  proy_nexa_interface__srv__MyMoveMsg_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember MyMoveMsg_Request__rosidl_typesupport_introspection_c__MyMoveMsg_Request_message_member_array[1] = {
  {
    ...
    offsetof(proy_nexa_interface__srv__MyMoveMsg_Request, move),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers MyMoveMsg_Request__rosidl_typesupport_introspection_c__MyMoveMsg_Request_message_members = {
  "proy_nexa_interface__srv",  // message namespace
  "MyMoveMsg_Request",  // message name
  1,  // number of fields
  sizeof(proy_nexa_interface__srv__MyMoveMsg_Request),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, proy_nexa_interface, srv, MyMoveMsg_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  proy_nexa_interface__srv__MyMoveMsg_Response__init(message_memory);
}

void MyMoveMsg_Response__rosidl_typesupport_introspection_c__MyMoveMsg_Response_fini_function(void * message_memory)
{
  proy_nexa_interface__srv__MyMoveMsg_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember MyMoveMsg_Response__rosidl_typesupport_introspection_c__MyMoveMsg_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(proy_nexa_interface__srv__MyMoveMsg_Response, success),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers MyMoveMsg_Response__rosidl_typesupport_introspection_c__MyMoveMsg_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(proy_nexa_interface__srv__MyMoveMsg_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_proy_nexa_interface
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, proy_nexa_interface, srv, MyMoveMsg_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers proy_nexa_interface__srv__detail__my_move_msg__rosidl_typesupport_introspection_c__MyMoveMsg_service_members = {
  "proy_nexa_interface__srv",  // service namespace
  "MyMoveMsg",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // proy_nexa_interface__srv__detail__my_move_msg__rosidl_typesupport_introspection_c__MyMoveMsg_Request_message_type_support_handle,
  NULL  // response message
  // proy_nexa_interface__srv__detail__my_move_msg__rosidl_typesupport_introspection_c__MyMoveMsg_Response_message_type_support_handle
};

static rosidl_service_type_support_t proy_nexa_interface__srv__detail__my_move_msg__rosidl_typesupport_introspection_c__MyMoveMsg_service_type_support_handle = {
  0,
  &proy_nexa_interface__srv__detail__my_move_msg__rosidl_typesupport_introspection_c__MyMoveMsg_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, proy_nexa_interface, srv, MyMoveMsg)() {
  if (!proy_nexa_interface__srv__detail__my_move_msg__rosidl_typesupport_introspection_c__MyMoveMsg_service_type_support_handle.typesupport_identifier) {
    proy_nexa_interface__srv__detail__my_move_msg__rosidl_typesupport_introspection_c__MyMoveMsg_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)proy_nexa_interface__srv__detail__my_move_msg__rosidl_typesupport_introspection_c__MyMoveMsg_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, proy_nexa_interface, srv, MyMoveMsg_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, proy_nexa_interface, srv, MyMoveMsg_Response)()->data;
  }

  return &proy_nexa_interface__srv__detail__my_move_msg__rosidl_typesupport_introspection_c__MyMoveMsg_service_type_support_handle;
}
